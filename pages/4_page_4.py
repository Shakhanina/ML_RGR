...
if button1:
    ...
    st.write(f'Результат предсказания DecisionTreeClassifier - {predict_gini_clf}')
    ...
    st.write(f'Результат метрики f1 модели DecisionTreeClassifier- {f1_score(y_test, predict_knn)}')
